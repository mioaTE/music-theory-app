<template>
  <div class="box">
    <h1 class="title">MUSIC THEORY QUIZ</h1>
    <div class="level-buttons">
      <button @click="selectLevel(1)">Level1</button>
      <button @click="selectLevel(2)">Level2</button>
      <button @click="selectLevel(3)">Level3</button>
    </div>
